...
interface SidebarContentProps {
  ...
  setSettings: (s: PdfExportSettings) => void;
  setIsSidebarOpen: (o: boolean) => void;
  onGenerate: (s: PdfExportSettings) => void;
  toggleSection: (s: keyof Pick<PdfExportSettings, 'includeCharts' | 'includeCover' | 'showRecommendations' | 'showAiSummary' | 'compactMode'>) => void;
  themes: { id: PdfTheme; label: string; desc: string }[];
}

const SidebarContent = ({ settings, setSettings, setIsSidebarOpen, onGenerate, toggleSection, themes }: SidebarContentProps) => (
