  ...
  const handleSubmit = async (e: React.SyntheticEvent) => {
    ...
    try {
      const response = await api.post("/api/leads", {
        ...
        website, // honeypot field — server silently rejects if non-empty
      });
            ...
            <AnimatePresence mode="wait">
              ...
              {step === "individual" && (
                ...
                >
                  ...
                  {/* Honeypot field — hidden via CSS, invisible to real users, bots will fill it */}
                  <div
                    style={{
                      position: "absolute",
                      left: "-9999px",
              ...
              {step === "company" && (
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-zinc-400 mb-5">
                      Tell us about your organization to receive a tailored
